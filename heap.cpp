...
class BinaryHeap
{
    ...
    int getParent(int i)//function to return the index of the parent of the node at the index i
    {
        return (i-1)/2;
    }
    int getLeft(int i)//function to return the index of the left child of the node at the index i
    {
        return (i*2)+1;
    }
    int getRight(int i)//function to return the index of the right child of the node at the index i
    {
        return (i*2)+2;
    }
    int getMin()//function to return the minimum element in the heap
    {
        return arr[0];
    }
    ...
    void display(int i,int space)//function to display the elements as a tree
    {
        if(i<currSize)//if the end of the subtree has not been reached
        {
            ...
            display(getLeft(i),space);//the left subtree is displayed
        }
    }//end of function to display the elements as a tre
    ...
    }//end of the function to delete the element at the index i
